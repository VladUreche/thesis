...
\lstset{frame=tb,
  ...
  columns=flexible,
  basicstyle={\footnotesize \ttfamily \setstretch{0.98}},
  numbers=left,
...
\SetWatermarkText{\hspace*{8in}\raisebox{5.0in}{\includegraphics[scale=0.1]{aec-badge.eps}}}
\SetWatermarkAngle{0}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{document}

% Formatting - no widow lines
\clubpenalty=10000
\widowpenalty = 10000

%% OOPSLA CONFERENCE INFORMATIION %%
\exclusivelicense
\conferenceinfo{OOPSLA~'14}{October 19-21 2014, Portland, OR, USA}
\copyrightyear{2014}
...
\title{Late Data Layout: \Large{Unifying Data Representation Transformations}}
\authorinfo{Vlad Ureche \and Eugene Burmako \and Martin Odersky}
           {EPFL, Switzerland}
           {\{first.last\}@epfl.ch}
\maketitle
...
\keywords
Data Representation; Object-oriented; Annotated Types; Type Systems; Local Type Inference
...
Last but not least, Vlad is grateful to his wife Ana Lucia and his family who supported him through very difficult times when this paper was written. \inv{Vă pup!}
